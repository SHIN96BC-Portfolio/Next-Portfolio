import 'server-only';
import { Locale, Namespace } from '@FsdShared/libs/i18n';
import { DictionaryNamespaceMap } from '@FsdShared/libs/i18n/i18n-type';
import getI18nDictionary from '@FsdShared/libs/i18n/utils/get-i18n-dictionary';
