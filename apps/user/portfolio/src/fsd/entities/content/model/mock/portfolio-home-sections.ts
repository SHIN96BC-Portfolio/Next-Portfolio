import { portfolioProjectsMock } from '@FsdEntities/content/model/mock/portfolio-projects.mock';
import { portfolioSkillsMock } from '@FsdEntities/content/model/mock/portfolio-skills.mock';
import { HomeSectionRes, PAGE_KEY, SECTION_TYPE } from '@FsdEntities/content/model/types';

export const portfolioHomeSectionsMock: HomeSectionRes[] = [
  {
    id: 'sec-hero',
...
AI 시대에는 코드를 얼마나 많이 작성했는지보다, **문제를 얼마나 정확하게 정의하고 AI를 통해 빠르게 가치를 만들어내는지**가 더 중요하다고 믿습니다. 서비스 전체 구조, 비즈니스 흐름, 문제의 본질을 이해하는 역량이 필수적이며, 저는 문제를 깊게 분석하고 리스크를 사전에 파악하며 정확한 질문을 던지는 습관을 꾸준히 만들어가고 있습니다.`,
  ...
  },
  {
    ...
    isActive: true,
    config: {
      companies: portfolioProjectsMock,
    },
  },
  {
    id: 'sec-career',
