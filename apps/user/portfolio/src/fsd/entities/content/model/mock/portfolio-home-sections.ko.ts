...
· **풀스택·인프라 대응** — 프론트엔드 주력, Java/Spring·Nest.js 백엔드부터 CI/CD 파이프라인·K8s 인프라 재설계까지 배포·운영 전반에 대한 경험
...
· **CI/CD 파이프라인·K8s 인프라 재설계 참여** — 멀티서비스(B2C·BP·ONBP) 배포 파이프라인을 서비스·환경별로 세분화하여 재설계, Azure Local ARC 전환·DR 페일오버 구성에 기여. 빌드~배포 30분+ → 12~15분 단축, 페이지 로딩 약 1/3 수준으로 단축 (SSG/SSR 조합·캐싱·useEffect 정리)
