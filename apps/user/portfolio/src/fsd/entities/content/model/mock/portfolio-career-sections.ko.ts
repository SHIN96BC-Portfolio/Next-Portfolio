...
const CAREER_INTRO_BODY =
  '5년차 프론트엔드 개발자로, 레거시 서비스의 차세대 재구축과 End-to-End 신규 개발을 모두 수행해왔습니다. 대규모 리팩터링·성능 최적화·풀스택 대응에 강점이 있고, 전환을 안전하게 만드는 테스트·품질 체계와 AI 에이전트 컨텍스트 설계까지 직접 구축해왔습니다. 아래는 대표 프로젝트를 **문제 → 해결 → 성과** 관점으로 정리한 내용입니다.';
...
- **AI 에이전트가 아키텍처 경계를 지키도록 컨텍스트를 설계**하는 역량
